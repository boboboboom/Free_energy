...
_C.DATALOADER.SOURCE.BATCH_SIZE = 64
# Setting for the target data-loader
_C.DATALOADER.TARGET = CN()
_C.DATALOADER.TARGET.BATCH_SIZE = 64
...
_C.MODEL.BACKBONE.NAME = 'resnet18'  # resnet18 or resnet50
...
_C.TRAINER.ENERGY_ALIGN_TYPE = 'max' # l1 or mse or max
_C.TRAINER.ENERGY_ALIGN_WEIGHT = 0.01
# _C.TRAINER.ACTIVE_ROUND = []
_C.TRAINER.ACTIVE_ROUND = [42,44,46,48]
